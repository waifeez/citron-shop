...
function LostGiftArt() {
  return (
    <svg viewBox="0 0 200 180" width="200" height="180" fill="none">
      ...
      <rect x="30" y="35" width="70" height="16" rx="4" fill="#F5D800" stroke="#153726" strokeWidth="4" transform="rotate(-18 65 43)" />
      <text x="90" y="80" fontSize="34" fontWeight="700" fill="#1E7A4C" fontFamily="'Fraunces', serif">?</text>
    </svg>
  );
}
...
export function NotFoundPage() {
  ...
  return (
    <Box>
      <PageHeader title="404" subtitle="Такой страницы не существует" compact />
      <Container sx={{ py: 8, textAlign: 'center' }}>
        <Box sx={{ mb: 3 }}>
          <LostGiftArt />
        </Box>
        <Typography color="text.secondary" sx={{ mb: 4 }}>
          Но в каталоге точно есть что-то интересное.
        </Typography>
